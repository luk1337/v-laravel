...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h2 style="margin-top: 0">Editing list 〜 {{ $list->name }}</h2>
            ...
            <form class="form-horizontal" method="post">
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-4">
                        <input id="name" type="text" maxlength="32" class="form-control" name="name" placeholder="Name" value="{{ (old('name') ?: $list->name) }}" required autofocus>
                    </div>
                </div>
