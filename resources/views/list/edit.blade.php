                ...
                <div class="col col-md-6 col-xl-4">
                    <form class="form-horizontal" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" maxlength="64" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" placeholder="{{ __('Name') }}" value="{{ old('name') ?: $list->name }}" required autofocus>
                        ...
                        <div class="form-group">
                            <label for="privacy" class="control-label">{{ __('Privacy') }}</label>
